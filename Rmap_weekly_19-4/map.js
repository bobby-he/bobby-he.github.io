...
const rt_path = RT_PATH;
const case_projection_path = CASE_PROJECTION_PATH;
const case_prediction_path = CASE_PREDICTION_PATH;
const case_weekly_path = CASE_WEEKLY_PATH;
const pexceed_path = PEXCEED_PATH;
